...
execute as @a unless score @s nh_durabilityCurrent = @s nh_durabilityPrevious run execute if score @s nh_heldIDCurrent = @s nh_heldIDPrevious run function nh_metals:durability/check_for_durability_reset
...
execute as @a unless score @s nh_durabilityOffhandCurrent = @s nh_durabilityOffhandPrevious run execute if score @s nh_heldOffhandIDCurrent = @s nh_heldOffhandIDPrevious run function nh_metals:durability/check_for_durability_reset

...
execute as @a unless score @s nh_usesIronPick = @s nh_usesIronPick_prev run execute if score @s nh_usesIronPick_mod matches 0 run function nh_metals:durability/reset_current_item_durability
...
execute as @a unless score @s nh_usesIronAxe = @s nh_usesIronAxe_prev run execute if score @s nh_usesIronAxe_mod matches 0 run function nh_metals:durability/reset_current_item_durability
...
execute as @a unless score @s nh_usesIronShovel = @s nh_usesIronShovel_prev run execute if score @s nh_usesIronShovel_mod matches 0 run function nh_metals:durability/reset_current_item_durability
...
execute as @a unless score @s nh_usesIronSword = @s nh_usesIronSword_prev run execute if score @s nh_usesIronSword_mod matches 0 run function nh_metals:durability/reset_current_item_durability
...
execute as @a unless score @s nh_usesIronHoe = @s nh_usesIronHoe_prev run execute if score @s nh_usesIronHoe_mod matches 0 run function nh_metals:durability/reset_current_item_durability
